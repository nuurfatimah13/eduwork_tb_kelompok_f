                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-warning btn-sm mb-1" href="edit-fm.php?id=<?php echo $data["id"]; ?>">
                                                            <i class="align-middle" data-feather="edit"></i>
                                                            <span class="align-middle">Update</span>
                                                        </a>
                                                        |
                                                        <a class="btn btn-danger btn-sm mt-1" href="../../../controllers/film/delete-fm.php?id=<?php echo $data["id"]; ?>"
