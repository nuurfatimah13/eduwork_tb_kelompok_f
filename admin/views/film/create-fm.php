                            ...
                            <div class="card-body">
                                ...
                                <form class="row g-3 needs-validation" novalidate action="../../../controllers/film/create-fm.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="col md-12">
                                        ...
                                        <div class="input-group has-validation">
                                            <input type="text" name="judul" class="form-control" id="validationCustomName" aria-describedby="inputGroupPrepend" required>
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col md-12">
                                        ...
                                        <div class="input-group has-validation">
                                            <input type="text" name="tahun" class="form-control" id="validationCustomTahun" aria-describedby="inputGroupPrepend" required>
                                            <div class="invalid-feedback">
