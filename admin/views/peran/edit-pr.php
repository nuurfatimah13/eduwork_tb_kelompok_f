                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                $id = $_GET['id'];
                                $query = $conn->query("SELECT * FROM peran");
                                ...
                                <!-- Card Title -->
                                <h3 class="card-title mb-4">Update Data Peran</h3>
                                <form class="row g-3 needs-validation" novalidate action="../../../controllers/peran/update-pr.php?id=id" method="post" enctype="multipart/form-data">
                                    <div class="col-6">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="input-group has-validation">
                                            <input type="text" name="peran" class="form-control" id="validationCustomPeran" aria-describedby="inputGroupPrepend" value="<?php echo $peran; ?>" required>
                                            <div class="invalid-feedback">
