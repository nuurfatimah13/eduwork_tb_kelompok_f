                            ...
                            <div class="card">
                                <div class="card-body">
                                    <?php
                                        ...
                                        $query1 = $conn->query("SELECT * FROM peran");
                                        $query2 = $conn->query("SELECT * FROM film");
                                        $query3 = $conn->query("SELECT * FROM cast");
                                    ?>
                                    <!-- Card Title -->
                                    <h3 class="card-title mb-4">Create Data Template</h3>
                                    <form class="row g-3 needs-validation" novalidate 
                                        action="../../../controllers/peran/create-pr.php" 
                                        method="post" 
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="input-group has-validation">
                                                <select class="form-select" name="cast_id" 
                                                    id="validationCast" required>
                                                    <option disabled value="">Pilih...</option>
                                                    <?php 
