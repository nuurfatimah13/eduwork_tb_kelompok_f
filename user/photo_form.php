                ...
                <div class="row center_o1 text-center">
                    <div class="col-md-12">
                        ...
                        <h5 class="bg_dark d-inline-block p-4 mb-0 mt-4 pt-2 pb-2 fw-normal col_red">
                            ...
                            <span class="me-2 ms-2 text-muted"> /</span> Photo Form
                        </h5>
                    </div>
                </div>
            </div>
                                        ...
                                        <form class="row g-3 needs-validation" 
                                            ...
                                            <div class="col-md-6">
                                                <img 
                                                    ...
                                                    alt="<?= $name; ?>">
                                                <br />
                                                <span class="col_red">current photo</span>
                                            </div>
                                            <div class="col-md-6">
                                                <label for="validationCustomImage" class="form-label col_light">
                                                    Photo
                                                </label>
                                                <div class="input-group has-validation">
                                                    ...
                                                    <input type="file" name="image[]" value="<?= $photo;?>"
                                                        class="form-control" id="validationCustomImage" aria-describedby="inputGroupPrepend" required>
