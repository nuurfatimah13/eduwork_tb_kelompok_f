<?php
    ...
    if (isset($_POST['update-photo'])) {
        ...
        if (unlink("../../assets/img/uploads/$previous")) {
            if(!in_array($ext,$ekstensi) ) {
                header("Location:../../user/profile_form.php?id=$id&alert=gagal_ekstensi");
            }else{
                if($ukuran < 1044070){		
                    ...
                    header("Location:../../user/profile.php?id=$id&success=update");
                }else{
                    header("Location:../../user/profile_form.php?id=$id&alert=gagal_ukuran");
                }
            }
        }
    } 
    ...
    if(isset($_POST['update-profile'])){
        ...
        $query = mysqli_query($conn,"UPDATE users SET name='$name', email='$email', 
            age='$age', bio='$bio', address='$address' WHERE id=$id");
        header("Location:../../user/profile.php?id=$id&success=update");
